...
public abstract class Character extends GameObject
{
	...
	public Type secondType = Type.NORMAL;
	public int shield;
	...
	public double hitCoefficient(Type t)
	{
		double d = 1;
		Type x = this.type;
		if(this.owner.equals(this.game.currentOpponent()))
			x = this.camouflage;
		...
		if (!(this.secondType == this.type) && (this.type.equals(this.camouflage) || this.owner.equals(this.game.currentPlayer())))
		{
			x = this.secondType;
			double y=d;
			d=1;
	...
	public boolean combatDamage(int f, final Character source)
	{
		...
		if(this.angelicHalo)
		{
			this.game.log(String.valueOf(this.name) + " loses angelic halo!");
			return this.angelicHalo = false;
		}
		this.game.log(String.valueOf(source.name) + " deals " + f + " damage to " + this.name);
	...
	public boolean combatSpellDamage(int f, Type t, final Character source)
	{
		...
		if(this.angelicHalo)
		{
			this.game.log(String.valueOf(this.name) + " loses divine shield");
			return this.angelicHalo = false;
		}
	...
	{
		this.game.log(String.valueOf(this.name) + " gains +" + a + "/+" + h);
		this.attack += a;
		this.health += h;
	}
	...
	public void freeze(final int turns)
	{
		...
		this.game.log(String.valueOf(this.name) + " frozen");
	}
