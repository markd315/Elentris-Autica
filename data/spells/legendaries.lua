...
local spell = Card:createMinion(0, 'Kelth Bluelight', 9, 120, 0, 'Taunt.  Heal 50 health to a character.', 50, 95);
spell.onCast = function() game:chooseTarget(character,function() this():heal(50); end); end;
spell.taunt = true;

local spell = Card:createMinion(0,'Gwenyth Bladestar', 9, 256, 0, 'Deal 60 damage to all characters.', 60, 60);
...
local spell = Card:createMinion(0, 'Awryb Steelpaw', 11, 0, 0, 'TAUNT, DIVINE SHIELD', 50, 160); --210 stats, 1.8 power effect
  spell.divineShield = true;
  spell.taunt = true;
