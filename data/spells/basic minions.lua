...
local spell = Card:createMinion(0, 'Water Dancer', 'WATER', 2, 2, 0, 'WATER', 25, 25);

local spell = Card:createMinion(0, 'Fire Dancer', 'FIRE', 2, 2, 0, 'FIRE', 25, 25);

local spell = Card:createMinion(0, 'Nature Dancer', 'NATURE', 2, 2, 0, 'NATURE', 25, 25);

local spell = Card:createMinion(0, 'Tempo Dancer', 'TIME', 2, 2, 0, 'TIME', 25, 25);

local spell = Card:createMinion(0, 'Alliance Dancer', 'ALLIANCE', 2, 2, 0, 'ALLIANCE', 25, 25);

local spell = Card:createMinion(0, 'Night Dancer', 'DARK', 2, 2, 0, 'DARK', 25, 25);

local spell = Card:createMinion(0, 'Sunrise Dancer', 'LIGHT', 2, 2, 0, 'LIGHT', 25, 25);

local spell = Card:createMinion(0, 'Mystic Dancer', 'SPIRIT', 2, 2, 0, 'SPIRIT', 25, 25);
...
local spell = Card:createMinion(0,'Fire Summoner', 'fire', 7, 32, 0, 'FIRE.  Summon a FIRE 32/32', 65, 50);
...
local spell = Card:createMinion(0,'Nature Summoner', 'Nature', 7, 32, 0, 'NATURE.  Summon a NATURE 32/32', 65, 50);
...
local spell = Card:createMinion(0,'Dark Summoner', 'Dark', 7, 32, 0, 'DARK.  Summon a DARK 32/32', 65, 50);
...
local spell = Card:createMinion(0,'Light Summoner', 'Light', 7, 32, 0, 'LIGHT.  Summon a LIGHT 32/32', 65, 50);
...
local spell = Card:createMinion(0,'Alliance Summoner', 'Alliance', 7, 32, 0, 'ALLIANCE.  Summon a ALLIANCE 32/32', 65, 50);
...
local spell = Card:createMinion(0,'Spirit Summoner', 'Spirit', 7, 32, 0, 'SPIRIT.  Summon a SPIRIT 32/32', 65, 50);
...
local spell = Card:createMinion(0,'Time Summoner', 'Time', 7, 32, 0, 'TIME.  Summon a TIME 32/32', 65, 50);
...
local spell = Card:createMinion(0,'Industry Summoner', 'Industry', 7, 32, 0, 'INDUSTRY.  Summon a INDUSTRY 32/32', 65, 50);
...
local spell = Card:createMinion(0, 'Light Legionary', 'LIGHT', 8, 60, 0, 'LIGHT', 125, 65);
local spell = Card:createMinion(0, 'Fire Legionary', 'FIRE', 8, 60, 0, 'FIRE', 125, 65);
local spell = Card:createMinion(0, 'Water Legionary', 'WATER', 8, 60, 0, 'WATER', 125, 65);
local spell = Card:createMinion(0, 'Nature Legionary', 'NATURE', 8, 60, 0, 'NATURE', 125, 65);
local spell = Card:createMinion(0, 'Industry Legionary', 'INDUSTRY', 8, 60, 0, 'INDUSTRY', 125, 65);
local spell = Card:createMinion(0, 'Spirit Legionary', 'SPIRIT', 8, 60, 0, 'SPIRIT', 125, 65);
local spell = Card:createMinion(0, 'Dusk Legionary', 'DARK', 8, 60, 0, 'DARK', 125, 65);
local spell = Card:createMinion(0, 'Alliance Legionary', 'ALLIANCE', 8, 60, 0, 'ALLIANCE', 125, 65);
local spell = Card:createMinion(0, 'Time Legionary', 'TIME', 8, 60, 0, 'TIME', 125, 65);
