...
local spell = Card:createSpell(198,'Ice Ray', 'WATER', 2, 0, 1, 0, 'Deal $SPELL_POWER:25$ WATER damage and freeze');
	spell.onCast = function() game:chooseTarget(character,function() this():spellDamage(25,'WATER',game:currentPlayer()); this():freeze(); end); end;
